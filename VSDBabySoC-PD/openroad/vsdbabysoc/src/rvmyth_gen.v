...
logic [31:0] w_CPU_dmem_rd_data_a4,
             CPU_dmem_rd_data_a5;
...
logic clkP_CPU_rs2_valid_a2 ;
   ...
   //
      ...
      always_ff @(posedge clkP_CPU_dmem_rd_en_a5) CPU_dmem_rd_data_a5[31:0] <= w_CPU_dmem_rd_data_a4[31:0];
      ...
      // Staging of $rd.
      always_ff @(posedge clkP_CPU_rd_valid_a2) CPU_rd_a2[4:0] <= w_CPU_rd_a1[4:0];
      ...
      // Staging of $rs1.
      always_ff @(posedge clkP_CPU_rs1_valid_a2) CPU_rs1_a2[4:0] <= w_CPU_rs1_a1[4:0];

      // Staging of $rs1_valid.
      always_ff @(posedge clk) CPU_rs1_valid_a2 <= CPU_rs1_valid_a1;

      // Staging of $rs2.
      always_ff @(posedge clkP_CPU_rs2_valid_a2) CPU_rs2_a2[4:0] <= w_CPU_rs2_a1[4:0];
